        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TarifaMensual = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TarifaCobrada = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservacionesHabitacion", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReservacionesHabitacion_Clientes_ClienteId",
                        column: x => x.ClienteId,
                        principalTable: "Clientes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ReservacionesHabitacion_Habitaciones_HabitacionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AsignacionesParqueo", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AsignacionesParqueo_Clientes_ClienteId",
                        column: x => x.ClienteId,
                        principalTable: "Clientes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AsignacionesParqueo_Parqueos_ParqueoId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrecioCobrado = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrdenesServicioDetalle", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrdenesServicioDetalle_OrdenesServicio_OrdenServicioId",
                        column: x => x.OrdenServicioId,
                        principalTable: "OrdenesServicio",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrdenesServicioDetalle_Servicios_ServicioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AsignacionesParqueo_ClienteId",
                table: "AsignacionesParqueo",
                column: "ClienteId");

            migrationBuilder.CreateIndex(
                name: "IX_AsignacionesParqueo_ParqueoId",
                table: "AsignacionesParqueo",
                column: "ParqueoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrdenesServicioDetalle_OrdenServicioId",
                table: "OrdenesServicioDetalle",
                column: "OrdenServicioId");

            migrationBuilder.CreateIndex(
                name: "IX_OrdenesServicioDetalle_ServicioId",
                table: "OrdenesServicioDetalle",
                column: "ServicioId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservacionesHabitacion_ClienteId",
                table: "ReservacionesHabitacion",
                column: "ClienteId");

            migrationBuilder.CreateIndex(
                name: "IX_ReservacionesHabitacion_HabitacionId",
                table: "ReservacionesHabitacion",
                column: "HabitacionId");
